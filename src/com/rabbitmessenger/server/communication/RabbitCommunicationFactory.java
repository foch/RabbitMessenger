...
public class RabbitCommunicationFactory {

	public static RabbitCommunication getImplementation(String rabbitName) {
		if ("BugsBunny".equalsIgnoreCase(rabbitName)) {
			return new DemoRabbitCommunication();
		} else {
			return new WebRabbitCommunication();
		}
	}
